...
class CriticNetwork(keras.Model):
    def __init__(self, name='critic', chkpt_dir=r"""C:\Users\yonathanb\Desktop\studies\year3\semester2\ai\exercises\practical\AI-scooters\models\period_3"""):
...
class ActorNetwork(keras.Model):
    def __init__(self,  n_actions, name='actor',
                 chkpt_dir=r"""C:\Users\yonathanb\Desktop\studies\year3\semester2\ai\exercises\practical\AI-scooters\models\period_3"""):
